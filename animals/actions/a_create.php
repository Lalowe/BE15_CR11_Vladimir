...
if ($_POST) {
    ...
    $sql = "INSERT INTO animals (name, description, breed, hobbies,size,age,live_at,picture ) VALUES ('$name','$description','$breed','$hobbies','$size' ,$age, '$live_at', '$picture->fileName')";
